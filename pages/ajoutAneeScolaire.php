<?php 
    ...
    if(isset($btnSubAnne)){
        ...
        if(empty($annee)){
            ...
            $dateDebut = "None";
            $dateFin = "None";
            ajoutAnneeScolaire($annee, $dateDebut, $dateFin);
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>AJOUTER UNE ANNEES UNIVERSITAIRES</h3>
                </div>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="annee">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdateDebut">Date debut </label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' id="fdateDebut" name="dateDebut">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdateFin">Date fin </label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' id="fdateFin" name="dateFin">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
