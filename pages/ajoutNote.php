<?php 
    ...
    if(isset($btnAjouter)){
        ...
        if(empty($note) || empty($enseignant) || empty($etudiant) || empty($matiere)){
            ...
            if(verifyNoteExiste($etudiant, $matiere)){
                $errors = "Attention!!! cet etudiant a déjà une note dans cette matiere";
            }else{
                ajoutNote($note, $enseignant, $etudiant, $matiere);
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Moyenne *</label>
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="note">
                                </div>
                                <?php if(isset($errors)) : ?>
