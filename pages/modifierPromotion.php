<?php 
    ...
    if(isset($_GET['code'])){
        ...
        if(isset($btnModifier)){
            $promotion = securite($promotion);
            $dateDebut = securite($dateDebut);
            $dateFin = securite($dateFin);
            if(empty($annee)){
                $errors = "Tous les champs sont obligatoires";
            }else{
                updatePromotion($dateDebut, $dateFin, $code);
        ...
        <div class="dashboard-page-one">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <?php if($infoUser['droit']=="Super Admin" || $infoUser['droit']=="Admin"): ?>
                            ...
                            <li class="nav-item ">
                                <a href="listPromotion.php" class="nav-link menu-active"><i class="flaticon-menu-1"></i><span>Promotions</span></a>
                            </li>
            ...
            <div class="dashboard-content-one">
                ...
                <?php 
                    ...
                    $promotion->execute(array($code));
                    $resuslt=$promotion->fetch(PDO::FETCH_ASSOC);
                ?>
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <div class="header-elements my-2">
                                        <ul>
                                            <li><a href="listPromotion.php"><i class="fas fa-angle-left"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="annee" value="<?php echo $resuslt['code']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" name="btnModifier" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Modifier</button>
