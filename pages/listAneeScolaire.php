        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>LA LISTE DES ANNEES UNIVERSITAIRES</h3>
                </div>
                    ...
                    <div class="card-body">
                                ...
                                <div class="item-content">
                                    <div class="header-inline item-header">
                                        <div class="header-elements my-2">
                                            <ul>
                                                <li><a href="ajoutAneeScolaire.php"><i class="fas fa-plus-circle"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach (getAnneScolaire() as $annee): ?>
                                    <tr class="text-center">
                                        <td>
                                            <?php echo $annee['code']; ?>
                                        </td>
                                        <td>
                                            <?php echo $annee['dateDebut']; ?>
                                        </td>
                                        <td>
                                            <?php echo $annee['dateFin']; ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="supprimerAneeScolaire.php?code=<?php echo $annee['code']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet enregistrement?')"><i class="fas fa-times text-orange-red"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="modifierAneeScolaire.php?code=<?php echo $annee['code']; ?>"><i class="fas fa-edit text-dark-pastel-green"></i> Modifier</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
