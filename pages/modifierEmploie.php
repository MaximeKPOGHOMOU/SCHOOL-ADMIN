<?php 
    ...
    if(isset($btnAjouter)){
        ...
        if(empty($matiere) || empty($enseignant) || empty($promotion) || empty($licence) || empty($salle) || empty($jour) || empty($heure)){
            ...
            updateEmplois($enseignant, $matiere, $promotion, $licence, $salle, $jour, $heure, $code);
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>MODIFIER UN EMPLOIS DE TEMPS </h3>
                </div>
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <?php 
                            ...
                            WHERE emploi_temps.code=?");  

                            $emplois->execute(array($code));
                            $resuslt=$emplois->fetch(PDO::FETCH_ASSOC);
                        ?>
                        <form class="new-added-form" method="post">
                            <div class="row">
                                    ...
                                    <option value="">Choisir une promotion *</option>
                                        <?php                  
                                            ...
                                            foreach($promotions as $promotion) {
                                                if($resuslt['promotion'] == $promotion['code']) {
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" id="fsalle" name="salle">
                                        ...
                                        <?php                  
                                            ...
                                            foreach(getSalle() as $salle) {
                                                if($resuslt['salle'] == $salle['libele']) {
                                                    echo "<option value='".$salle['code']."' selected>".$salle['libele']."</option>";
                                                } else {
                                                    echo "<option value='".$salle['code']."'>".$salle['libele']."</option>";
                                                }
                                            }
                                        ?>                                                         
                                    </select>
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fheure" name="heure" value="<?php echo $resuslt['heur']; ?>">
                                </div>
                                <?php if(isset($errors)) : ?>
