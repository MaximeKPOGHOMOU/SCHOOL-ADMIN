                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fsalle" name="salle">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fcapacite"> Capacite *</label>
                                    <input type="text" placeholder="" class="form-control" id="fcapacite" name="capacite">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="femplacement"> Emplacement *</label>
                                    <input type="text" placeholder="" class="form-control" id="femplacement" name="emplacement">
                                </div>
