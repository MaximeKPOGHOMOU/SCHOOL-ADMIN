...
if(isset($changerPassWord)){
    if(empty($actuel) || empty($nouveau) || empty($confirmation)){
        ...
        if($nouveau!=$confirmation){
            ...
            $errors = "L'ancien mot de passe est identique au nouveau mot de passe !";
        }else{
            if(verifyPassWord($actuel)){
                updatePassWord($nouveau);
                session_destroy();
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        <h3 class="id">CHANGER DE MOT DE PASSE</h3>
                        <div class="single-info-details">
                            <div class="item-content">
                            <form class="new-added-form" method="POST" action="">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label for="fnom">Ancien mot de passe *</label>
                                        <input type="password" placeholder="" class="form-control" id="fnom" name="actuel">
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label for="fnom">Nouveau mot de passe  *</label>
                                        <input type="password" placeholder="" class="form-control" id="fnom" name="nouveau">
                                    </div>
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <label for="fnom">Confirmation *</label>
                                        <input type="password" placeholder="" class="form-control" id="fnom" name="confirmation">
                                    </div>
                                    <?php if(isset($errors)) : ?>
                                    ...
                                    <div class="col-12 form-group mg-t-8">
                                        <button type="submit" name="changerPassWord"
                                            class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Changer</button>
                                    </div>
                                </div>
                            </form>
