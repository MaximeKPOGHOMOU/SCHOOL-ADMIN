                    ...
                    <div class="card-body">
                                ...
                                <div class="item-content">
                                    <div class="header-inline item-header">
                                        <div class="header-elements my-2">
                                            <ul>
                                                <li><a href="ajoutSemestre.php"><i class="fas fa-plus-circle"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach (getSemestre() as $annee): ?>
                                    <tr class="text-center">
                                        <td>
                                            <?php echo $annee['libele']; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="supprimerSemestre.php?code= <?php echo $annee['code']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer <?php echo $annee['libele'] ?> ?')" ><i class="fas fa-times text-orange-red"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="modifierSemestre.php?code=<?php echo $annee['code']; ?>"><i class="fas fa-edit text-dark-pastel-green"></i> Modifier</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
