<?php 
    ...
    if(isset($btnAjouter)){
        ...
        $email = securite($email);
        $password = securite($password);
        if(empty($nom) || empty($prenom) || empty($telephone) || empty($email) || empty($password) || empty($droit)){
            $errors = "Tous les champs sont obligatoiers";
        }elseif(telExisteUser($telephone)){
            $errors = "Cet numéro de téléphone existe déjà";
        }elseif(EmailExiste($email)){
            $errors = "Cet email existe déjà";
        }else{
            $lastName = strtoupper($nom);
            $firsrtName = ucfirst($prenom);
            ajoutUtilisateur($lastName, $firsrtName, $telephone, $email, $password, $droit);
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <?php if($infoUser['droit']=="Super Admin" || $infoUser['droit']=="Admin"): ?>
                            ...
                            <?php if($infoUser['droit']=="Super Admin"): ?>
                                <li class="nav-item ">
                                    <a href="listUtilisateur.php" class="nav-link menu-active"><i class="flaticon-shopping-list"></i><span>Utilisateurs</span></a>
                                </li>
                            <?php endif; ?> 
                        <?php endif;?>
                    </ul>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Nom *</label>
                                    <input type="text" placeholder="" class="form-control" id="fname" name="nom">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Prenom *</label>
                                    <input type="text" placeholder="" class="form-control" id="lastName" name="prenom">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Telephone *</label>
                                    <input type="text" placeholder="" class="form-control" id="ftelephone" name="telephone">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>email *</label>
                                    <input type="text" placeholder="" class="form-control" id="femail" name="email">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>password *</label>
                                    <input type="text" placeholder="" class="form-control" id="fpassword" name="password">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdroit">Droit *</label>
                                    <select class="select2" id="fdroit" name="droit">
