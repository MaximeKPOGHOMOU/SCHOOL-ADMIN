    ...
    if(isset($_GET['matricule'])) {
        ...
        if(isset($valider)){
            ...
            if(empty($nom)||empty($prenom)||empty($genre)||empty($telephone)||empty($adresse)||empty($matiere)||empty($diplome)||empty($status)){
                ...
                updateEnseignant($lastName, $firsrtName, $genre, $telephone, $adresse, $matiere, $diplome, $status, $matricule);
                        ...
                        <form class="new-added-form" method="POST" action="">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="nom" value="<?php echo $resuslt['nom'];?>">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label for="fprenom">Prénom *</label>
                                    <input type="text" placeholder="" class="form-control" id="fprenom" name="prenom" value="<?php echo $resuslt['prenom'];?>">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" id="fmatiere" name="matiere">
                                        ...
                                        <?php                  
                                        $pdo=database();
                                        $seletMatiere=$pdo->query('SELECT*FROM matiere')->fetchAll(PDO::FETCH_ASSOC);
                                        $matieres = $seletMatiere; 
                                        foreach($matieres as $matiere) {
                                            if($resuslt['matiere'] == $matiere['libele']) {
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="ftelephone"
                                        name="telephone" value="<?php echo $resuslt['telephone'];?>">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label for="fAdresse">Adresse</label>
                                    <input type="text" placeholder="" class="form-control" id="fAdresse" name="adresse" value="<?php echo $resuslt['adresse'];?>">
                                </div>          
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" id="fdiplome" name="diplome">
                                        ...
                                        <?php 
                                        $diplomes = array("Licence", "Master", "Doctorat", "Profesorat", "Autres");
                                        foreach($diplomes as $diplome){
                                            if($resuslt['diplome']==$diplome){
                                                echo '<option value="' . $diplome .'" selected>'. $diplome .'</option>'; 
                                            }else{
                                                echo '<option value="'.$diplome.'">' .$diplome.'</option>';
                                            }
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" id="fstatus" name="status">
                                        ...
                                        <?php 
                                        $status = array("Titulaire", "Contratuel", "Autres");
                                        foreach($status as $statu){
                                            if($resuslt['status_en']==$statu){
