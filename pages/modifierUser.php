    ...
    if(isset($_GET['id'])){
        ...
        if(isset($btnAjouter)){
            ...
            if(empty($nom) || empty($prenom) || empty($telephone) || empty($email) || empty($password) || empty($droit) ){
                ...
                updateUser($nom, $prenom, $telephone, $email, $password ,$droit, $id);
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fpassword" name="password" value="<?php echo $resuslt['pass_word']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdroit">Droit *</label>
                                    <SELect class="select2" name="droit">
                                    <option value="">Choisir un droit *</option>
                                    <?php 
                                        $users = array("Super Admin", "Admin", "User");
                                        foreach($users as $user){
                                            if($resuslt['droit']==$user){
