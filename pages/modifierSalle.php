<?php 
    ...
    if(isset($_GET['code'])){
        $salle = securite($salle);
        $emplacement = securite($emplacement);
        $capacite = securite($capacite);
        $code=$_GET['code'];
        if(isset($btnSubAnne)){
            if(empty($salle)||empty($capacite)||empty($emplacement)){
                $errors = "Tous les champs sont obligatoires";
            }else{
                $sal = strtoupper($salle);
                $empl = ucfirst($emplacement);
                updateSalle($sal, $capacite, $empl, $code);
    ...
    <div id="wrapper" class="wrapper bg-ash">
        ...
        <div class="dashboard-page-one">
            ...
            <?php 
                    ...
                    $salle->execute(array($code));
                    $resuslt=$salle->fetch(PDO::FETCH_ASSOC);
                ?>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fsalle" name="salle" value="<?php echo $resuslt['libele']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fcapacite"> Capacite *</label>
                                    <input type="text" placeholder="" class="form-control" id="fcapacite" name="capacite" value="<?php echo $resuslt['capacite']; ?>" >
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="femplacement"> Emplacement *</label>
                                    <input type="text" placeholder="" class="form-control" id="femplacement" name="emplacement" value="<?php echo $resuslt['emplacement']; ?>">
                                </div>
