<?php 
    ...
    // =========Ajouter dans la table annee universitaire==================
    if(isset($_GET['code'])){
        $code=$_GET['code'];
        if(isset($btnSubAnne)){
            $annee = securite($annee);
            $dateDebut = securite($dateDebut);
            $dateFin = securite($dateFin);
            if(empty($annee)){
                $errorsScolaire = "Veillez saisir l'année universitaire";
            }elseif(empty($dateDebut) || empty($dateFin)){
                $dateDebut = "None";
                $dateFin = "None";
                updateAnneeScolaire($dateDebut, $dateFin, $code);
                header('Location:listAneeScolaire.php');
            }else{
                updateAnneeScolaire($dateDebut, $dateFin, $code);
                header('Location:listAneeScolaire.php');
            }
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>MODIFIER UNE ANNEES UNIVERSITAIRES</h3>
                </div>
                ...
                <?php 
                    ...
                    $code=$_GET['code'];
                    $annee=$pdo->prepare("
                        SELECT * FROM annee_univer WHERE code=?");
                    $annee->execute(array($code));
                    $resuslt=$annee->fetch(PDO::FETCH_ASSOC);
                ?>
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <div class="header-elements my-2">
                                        <ul>
                                            <li><a href="listAneeScolaire.php"><i class="fas fa-angle-left"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="2020-2021" class="form-control" id="fnom" name="annee" value="<?php echo $resuslt['code']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdateDebut">Date debut </label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' id="fdateDebut" name="dateDebut" value="<?php echo $resuslt['dateDebut']; ?>">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="fdateFin">Date fin </label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker"
                                            data-position='bottom right' id="fdateFin" name="dateFin" value="<?php echo $resuslt['dateFin']; ?>">
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <?php if(isset($errorsScolaire)) : ?>

                                <span class="text-red mx-4">
                                    <?php echo $errorsScolaire; ?>
                                </span>
