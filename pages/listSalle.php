                    ...
                    <div class="card-body">
                                ...
                                <div class="item-content">
                                    <div class="header-inline item-header">
                                        <div class="header-elements my-2">
                                            <ul>
                                                <li><a href="ajoutSalle.php"><i class="fas fa-plus-circle"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach (getSalle() as $salle): ?>
                                    <tr class="text-center">
                                        <td>
                                            <?php echo $salle['libele']; ?>
                                        </td>
                                        <td>
                                            <?php echo $salle['capacite']; ?>
                                        </td>
                                        <td>
                                            <?php echo $salle['emplacement']; ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="supprimerSalle.php?code=<?php echo $salle['code']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet enregistrement?')"><i class="fas fa-times text-orange-red"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="modifierSalle.php?code=<?php echo $salle['code']; ?>"><i class="fas fa-edit text-dark-pastel-green"></i> Modifier</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
