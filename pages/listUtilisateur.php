                            ...
                            <form class="mg-b-20" method="POST" action="">
                                <div class="row gutters-8">
                                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                                        <select class="select2" id="fstatus" name="droit">
                                            ...
                                            <div class="item-content">
                                                <div class="header-inline item-header">
                                                    <div class="header-elements mx-5 my-2">
                                                        <ul>
                                                            <li><a href="ajoutUtilisateur.php"><i class="fas fa-plus-circle"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="supprimerUser.php?id=<?php echo $user['id']; ?>" onclick="return confirm('Voulez-vous supprimer utilisateur <?php echo '[ '.$user['prenom'].' '.$user['nom'].' ]'; ?> ?')"><i class="fas fa-times text-orange-red"></i> Supprimer</a>
                                                        <a class="dropdown-item" href="modifierUser.php?id=<?php echo $user['id']; ?>"><i class="fas fa-edit text-dark-pastel-green"></i> Modifier</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
