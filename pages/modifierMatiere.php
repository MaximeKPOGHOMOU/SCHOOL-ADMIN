<?php 
    ...
    if(isset($_GET['code'])){
        ...
        if(isset($btnSubAnne)){
            ...
            if(empty($mat)||empty($semestre)){
                $errors = "Tous les champs sont obligatoires";
            }else{
                $desc = ucfirst($description);
                $mat = strtoupper($matiere);
                updateMatiere($mat, $semestre, $desc, $code);
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <?php 
                    ...
                    WHERE matiere.code = ?");
                    $matiere->execute(array($code));
                    $resuslt=$matiere->fetch(PDO::FETCH_ASSOC);
                ?>  
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="matiere" value="<?php echo $resuslt['libele']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label for="flicence">Semestre *</label>
                                    <select class="select2" id="fmatiere" name="semestre">
                                        <option value="">Choisir un semestre *</option>
                                        <?php                  

                                        foreach(getSemestre() as $semestre) {
                                            if($resuslt['semestre'] == $semestre['libele']) {
                                                echo "<option value='".$semestre['code']."' selected>".$semestre['libele']."</option>";
                                            } else {
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fdescription" name="description" value="<?php echo $resuslt['descrip']; ?>">
                                </div>
                                <?php if(isset($errors)) : ?>
