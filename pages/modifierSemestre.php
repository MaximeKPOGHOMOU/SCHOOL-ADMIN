<?php 
    ...
    if(isset($_GET['code'])){
        ...
        if(isset($btnSubAnne)){
            ...
            if(empty($annee)){
                $errorsScolaire = "Veillez saisir le semestre";
            }elseif(empty($dateDebut) || empty($dateFin)){
                $dateDebut = "None";
                $dateFin = "None";
                updateSemestre($annee, $dateDebut, $dateFin, $code);
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <?php 
                    ...
                    $code=$_GET['code'];
                    $annee=$pdo->prepare("
                        SELECT * FROM semestre WHERE code=?");
                            ...
                            <div class="item-content">
                                <div class="header-inline item-header">
                                    <div class="header-elements my-2">
                                        <ul>
                                            <li><a href="listSemestre.php"><i class="fas fa-angle-left"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="new-added-form" method="post">
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" id="fnom" name="annee" value="<?php echo $resuslt['libele']; ?>">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
