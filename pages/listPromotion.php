                    ...
                    <div class="card-body">
                                ...
                                <div class="item-content">
                                    <div class="header-inline item-header">
                                        <div class="header-elements my-2">
                                            <ul>
                                                <li><a href="ajoutPromotion.php"><i class="fas fa-plus-circle"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach (getPromotion() as $promotion): ?>
                                    <tr class="text-center">
                                        <td>
                                            <?php echo $promotion['code']; ?>
                                        </td>
                                        <td>
                                            <?php echo $promotion['dateDebut']; ?>
                                        </td>
                                        <td>
                                            <?php echo $promotion['dateFin']; ?>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="supprimerPromotion.php?code=<?php echo $promotion['code']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer cet enregistrement?')"><i class="fas fa-times text-orange-red"></i> Supprimer</a>
                                                    <a class="dropdown-item" href="modifierPromotion.php?code=<?php echo $promotion['code']; ?>"><i class="fas fa-edit text-dark-pastel-green"></i> Modifier</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
